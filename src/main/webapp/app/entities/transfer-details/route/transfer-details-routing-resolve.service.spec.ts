...
describe('TransferDetails routing resolve service', () => {
  ...
  let resultTransferDetails: ITransferDetails | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTransferDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITransferDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
