...
describe('PurchaseQuotation Management Component', () => {
  let comp: PurchaseQuotationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'purchase-quotation', component: PurchaseQuotationComponent }]),
      ...
      .overrideTemplate(PurchaseQuotationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.purchaseQuotations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to purchaseQuotationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPurchaseQuotationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPurchaseQuotationIdentifier).toHaveBeenCalledWith(entity);
