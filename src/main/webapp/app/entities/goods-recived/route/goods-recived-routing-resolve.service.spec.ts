...
describe('GoodsRecived routing resolve service', () => {
  ...
  let resultGoodsRecived: IGoodsRecived | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultGoodsRecived).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IGoodsRecived>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
