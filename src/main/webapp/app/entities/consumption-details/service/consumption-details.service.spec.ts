...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../consumption-details.test-samples';

import { ConsumptionDetailsService, RestConsumptionDetails } from './consumption-details.service';

const requireRestSample: RestConsumptionDetails = {
  ...sampleWithRequiredData,
  comsumptionDate: sampleWithRequiredData.comsumptionDate?.toJSON(),
};
...
describe('ConsumptionDetails Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ConsumptionDetails', () => {
      ...
      const consumptionDetails = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(consumptionDetails).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ConsumptionDetails', () => {
      const consumptionDetails = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(consumptionDetails).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addConsumptionDetailsToCollectionIfMissing', () => {
      it('should add a ConsumptionDetails to an empty array', () => {
        const consumptionDetails: IConsumptionDetails = sampleWithRequiredData;
      ...
      it("should add a ConsumptionDetails to an array that doesn't contain it", () => {
        const consumptionDetails: IConsumptionDetails = sampleWithRequiredData;
        const consumptionDetailsCollection: IConsumptionDetails[] = [sampleWithPartialData];
        expectedResult = service.addConsumptionDetailsToCollectionIfMissing(consumptionDetailsCollection, consumptionDetails);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(consumptionDetails);
      });
      ...
      it('should add only unique ConsumptionDetails to an array', () => {
        const consumptionDetailsArray: IConsumptionDetails[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const consumptionDetailsCollection: IConsumptionDetails[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const consumptionDetails: IConsumptionDetails = sampleWithRequiredData;
        const consumptionDetails2: IConsumptionDetails = sampleWithPartialData;
    ...
    describe('compareConsumptionDetails', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareConsumptionDetails(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareConsumptionDetails(entity1, entity2);
        const compareResult2 = service.compareConsumptionDetails(entity2, entity1);
