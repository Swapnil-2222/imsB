...
describe('ConsumptionDetails routing resolve service', () => {
  ...
  let resultConsumptionDetails: IConsumptionDetails | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultConsumptionDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IConsumptionDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
