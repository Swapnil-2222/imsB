...
describe('TransferDetailsApprovals routing resolve service', () => {
  ...
  let resultTransferDetailsApprovals: ITransferDetailsApprovals | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTransferDetailsApprovals).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITransferDetailsApprovals>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
