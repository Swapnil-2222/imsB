...
import { ProductInventoryService, RestProductInventory } from './product-inventory.service';

const requireRestSample: RestProductInventory = {
  ...sampleWithRequiredData,
  inwardOutwardDate: sampleWithRequiredData.inwardOutwardDate?.toJSON(),
