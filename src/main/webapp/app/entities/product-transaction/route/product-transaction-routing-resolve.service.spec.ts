...
describe('ProductTransaction routing resolve service', () => {
  ...
  let resultProductTransaction: IProductTransaction | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultProductTransaction).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IProductTransaction>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
